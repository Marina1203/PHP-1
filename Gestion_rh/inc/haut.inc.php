      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="nav1">
          ...
          if (internauteEstConnecte()){
            echo '<li><a class="nav-link" href="'.RACINE_SITE.'ajout_salarie.php">Salarie</a></li>';
          ...
          if(internauteEstConnecteEtAdmin()){
            echo '<li><a class="nav-link" href="'.RACINE_SITE.'admin/gestion_rh.php">Gestion rh</a></li>';
          }
				?>
        	</ul>
        </div>
